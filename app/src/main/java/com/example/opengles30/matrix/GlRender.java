package com.example.opengles30.matrix;
...
//        options.inJustDecodeBounds = true;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //绕z轴旋转90度
        Matrix.rotateM(unitMatrix, 0, 90, 0, 0, 1);
        Matrix.scaleM(unitMatrix, 0, 0.5f, 0.5f, 0.5f);
        floatBuffer = ByteBuffer.allocateDirect(unitMatrix.length * BYTES_PER_FLOAT)
                .order(ByteOrder.nativeOrder())
                .asFloatBuffer();
        floatBuffer.put(unitMatrix);
        ...
        //着色器
        vShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_VERTEX_SHADER, "triangle_matrix.vsh");
        fShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_FRAGMENT_SHADER, "triangle_matrix.fsh");
        ...
        GLES32.glUniformMatrix4fv(
                GLES32.glGetUniformLocation(shaderProgram, "transform"),
                1,
                false,
                floatBuffer
                );
        ...
        GLES32.glVertexAttribPointer(
                ...
                8 * BYTES_PER_FLOAT,//步长,连续的顶点属性组之间的间隔
                0
        );
