package com.example.opengles30.light_3;
...
public class GlRender implements GLSurfaceView.Renderer {
    ...
    //光源在场景的世界空间坐标中的位置
    float[] lightPosition = new float[]{0f, 1.0f, 0.5f};
    ...
    private void modelMatrix() {
        reset();
        Matrix.rotateM(unitMatrix, 0, 20, 1f, 0, 0);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //着色器
        vShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_VERTEX_SHADER, "triangle_light3.vsh");
        fShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_FRAGMENT_SHADER, "triangle_light3.fsh");
        ...
        GLES32.glUniform3f(GLES32.glGetUniformLocation(shaderProgram, "lightPos"), lightPosition[0], lightPosition[1], lightPosition[2]);
        GLES32.glUniform3f(GLES32.glGetUniformLocation(shaderProgram, "viewPos"), 0f, 0f, 10f);
        ...
        /**
         * 虽然对灯的着色器使用不能完全利用的顶点数据看起来不是那么高效，但这些顶点数据已经从箱子对象载入后开始就储存在GPU的内存里了，
