package com.example.opengles30.light_2;
...
public class GlRender implements GLSurfaceView.Renderer {
    ...
    private void modelMatrix() {
        reset();
        Matrix.rotateM(unitMatrix, 0, 20, 0.5f, 1, 0);
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //着色器
        vShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_VERTEX_SHADER, "triangle_light2.vsh");
        fShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_FRAGMENT_SHADER, "triangle_light2.fsh");
