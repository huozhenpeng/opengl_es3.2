package com.example.opengles30.coordinatesystem;
...
//     ---- 位置 ----       ---- 颜色 ----     - 纹理坐标 -
    ...
    private void modelMatrix() {
        reset();
        Matrix.rotateM(unitMatrix, 0, -55, 1, 0, 0);
    ...
    private void viewMatrix() {
        reset();
        Matrix.translateM(unitMatrix, 0, 0, 0, -3.0f);
...
//        options.inJustDecodeBounds = true;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //着色器
        vShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_VERTEX_SHADER, "triangle_3d_1.vsh");
        fShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_FRAGMENT_SHADER, "triangle_3d_1.fsh");
