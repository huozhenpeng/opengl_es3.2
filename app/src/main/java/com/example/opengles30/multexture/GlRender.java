package com.example.opengles30.multexture;
...
//        options.inJustDecodeBounds = true;
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //着色器
        vShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_VERTEX_SHADER, "triangle_mul_texture.vsh");
        fShader = ShaderUtils.loadShaderFromAssets(context, GLES32.GL_FRAGMENT_SHADER, "triangle_mul_texture.fsh");
